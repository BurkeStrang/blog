...
export const GlobalStyle = createGlobalStyle`
  :root, [data-theme="dark"] {
    ...
    --color-search-outline: rgba(0, 220, 200, 0.22);
    --color-search-outline-focus: rgba(0, 255, 220, 0.38);
    ...
    --color-filter-dropdown-bg: rgba(0, 26, 28, 0.55);
    --color-filter-border: rgba(0, 220, 200, 0.18);
...
export const Header = styled.header`
  ...
  [data-theme="light"] & h1 {
    color: color-mix(in srgb, color-mix(in srgb, var(--color-readable-lightgrey) 68%, black) 70%, transparent);
    text-shadow:
      0 0.06em 0.26em rgba(28, 31, 46, 0.15),
      0 0.22em 0.55em rgba(28, 31, 46, 0.04),
      0 0.5em 1.2em rgba(28, 31, 46, 0.006);
  }

  @media (max-width: 768px) {
    [data-theme="light"] & h1 {
      text-shadow:
        0 0.06em 0.22em rgba(28, 31, 46, 0.14),
        0 0.2em 0.48em rgba(28, 31, 46, 0.035),
        0 0.44em 1.05em rgba(28, 31, 46, 0.005);
    }
  }
  ...
  @media (max-width: 480px) {
    [data-theme="light"] & h1 {
      text-shadow:
        0 0.05em 0.12em rgba(28, 31, 46, 0.2),
        0 0.14em 0.3em rgba(28, 31, 46, 0.05),
        0 0.32em 0.85em rgba(28, 31, 46, 0.01);
    }
  }
