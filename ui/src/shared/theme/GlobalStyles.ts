...
//   0% {
//     transform: translate3d(30%, -5%, 0) scale(0.80);
//   }
//   100% {
//     transform: translate3d(-120%, 5%, 0) scale(1.2);
//   }
// `;
//
// const wander = keyframes`
//   0%   { margin-top: -2px;  margin-left: 0px; opacity: 0.95; }
//   5%   { margin-top: -10px;  margin-left: 0px; opacity: 0.8; }
//   10%  { margin-top: -20px;  margin-left: 1px; opacity: 0.7; }
//   15%  { margin-top: -10px;  margin-left: 1px; opacity: 0.5; }
//   20%  { margin-top: -5px;   margin-left: -1px; opacity: 0.7; }
//   25%  { margin-top: -4px;   margin-left: -1px; opacity: 0.8; }
//   30%  { margin-top: -3px;  margin-left: 2px; opacity: 0.9; }
//   35%  { margin-top: -2px;  margin-left: 2px; opacity: 1; }
//   40%  { margin-top: -1px;   margin-left: -2px; opacity: 1; }
//   45%  { margin-top: -1px;   margin-left: -2px; opacity: 1; }
//   50%  { margin-top: 0px;   margin-left: 1px; opacity: 0.8; }
//   55%  { margin-top: 0px;   margin-left: 1px; opacity: 1; }
//   60%  { margin-top: -2px;  margin-left: -1px; opacity: 0.9; }
//   65%  { margin-top: 20px;   margin-left: 10px; opacity: 0.8; }
//   70%  { margin-top: 1px;   margin-left: 20px; opacity: 0.9; }
//   75%  { margin-top: 0px;   margin-left: 1px; opacity: 1; }
//   80%  { margin-top: -1px;  margin-left: -2px; opacity: 0.9; }
//   85%  { margin-top: -3px;   margin-left: 1px; opacity: 0.8; }
//   90%  { margin-top: -10px;   margin-left: 1px; opacity: 0.6; }
//   95%  { margin-top: -15px;   margin-left: 1px; opacity: 0.8; }
//   100% { margin-top: -50px;   margin-left: 0px; opacity: 0.6; }
// `;
//
...
//     ${wander} 60s ease-in-out infinite alternate;
//
//   animation-delay:
//     ${({ $driftDelay = "0s" }) => $driftDelay},
//     ${({ $wanderDelay = "0s" }) => $wanderDelay};
// `;
